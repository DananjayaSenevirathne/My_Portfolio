...
export function About() {
    ...
    return (
        <section id="about" className="py-24 relative overflow-hidden flex items-center min-h-screen">
            <div className="container-custom grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 items-center">
                {/* Left Column: Branding Block */}
                <div className="order-2 md:order-1 space-y-6 relative text-center md:text-left px-4">
